...
namespace SpResearchTracker
{
    public static class WebApiConfig
    {
        public static void Register(HttpConfiguration config)
        {
            ...
            container.RegisterType<IResearchRepository, ResearchCSOMRepository>(new HierarchicalLifetimeManager());
            container.RegisterType<IProjectsRepository, ProjectsCSOMRepository>(new HierarchicalLifetimeManager());
            container.RegisterType<IReferencesRepository, ReferencesCSOMRepository>(new HierarchicalLifetimeManager());
